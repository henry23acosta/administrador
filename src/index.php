...
if($idnegocio != 1){
    $usuarios = mysqli_query($conexion, "SELECT * FROM autentificacion WHERE id_negocio = $idnegocio");
    $totalU= mysqli_num_rows($usuarios);
    $clientes = mysqli_query($conexion, "SELECT * FROM cliente WHERE id_negocio = $idnegocio");
    $totalC = mysqli_num_rows($clientes);
    $productos = mysqli_query($conexion, "SELECT * FROM productos WHERE id_negocio = $idnegocio");
    $totalP = mysqli_num_rows($productos);
    $ventas = mysqli_query($conexion, "SELECT * FROM factura WHERE id_negocio = $idnegocio");
    ...
    $totalP = mysqli_num_rows($productos);
    $ventas = mysqli_query($conexion, "SELECT * FROM factura");
    $totalV = mysqli_num_rows($ventas);
}
